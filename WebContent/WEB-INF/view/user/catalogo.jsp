...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/base.css?v=50">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/header.css?v=50">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/catalogo.css?v=50">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/footer.css?v=50">
</head>
...
<script src="${pageContext.request.contextPath}/scripts/carrello.js?v=50"></script>
